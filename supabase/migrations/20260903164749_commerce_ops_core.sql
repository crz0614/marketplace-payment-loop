...
begin
  ...
  insert into public.vco_imports(owner_id, shop_id, source_name, row_count)
  values (p_owner, p_shop, p_source, v_count)
  ...
  on conflict (shop_id, external_order_id, sku) do update set
